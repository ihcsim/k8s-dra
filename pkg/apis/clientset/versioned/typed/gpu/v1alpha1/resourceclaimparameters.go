...
type ResourceClaimParametersInterface interface {
	Create(ctx context.Context, resourceClaimParameters *v1alpha1.ResourceClaimParameters, opts v1.CreateOptions) (*v1alpha1.ResourceClaimParameters, error)
	Update(ctx context.Context, resourceClaimParameters *v1alpha1.ResourceClaimParameters, opts v1.UpdateOptions) (*v1alpha1.ResourceClaimParameters, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.ResourceClaimParameters, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.ResourceClaimParametersList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ResourceClaimParameters, err error)
	Apply(ctx context.Context, resourceClaimParameters *gpuv1alpha1.ResourceClaimParametersApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.ResourceClaimParameters, err error)
