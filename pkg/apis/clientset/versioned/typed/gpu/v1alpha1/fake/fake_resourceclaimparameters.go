...
func (c *FakeResourceClaimParameters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ResourceClaimParametersList, err error) {
	...
	list := &v1alpha1.ResourceClaimParametersList{ListMeta: obj.(*v1alpha1.ResourceClaimParametersList).ListMeta}
	for _, item := range obj.(*v1alpha1.ResourceClaimParametersList).Items {
