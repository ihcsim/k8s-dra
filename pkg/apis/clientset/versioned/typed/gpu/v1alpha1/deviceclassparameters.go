...
type DeviceClassParametersInterface interface {
	...
	Apply(ctx context.Context, deviceClassParameters *gpuv1alpha1.DeviceClassParametersApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.DeviceClassParameters, err error)
